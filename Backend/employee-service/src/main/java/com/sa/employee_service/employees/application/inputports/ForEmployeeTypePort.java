...
public interface ForEmployeeTypePort {
        ...
        public EmployeeTypeEntity createEmployeeType(EmployeeTypeEntity employeeType,
         ...
         * @throws NotFoundException si el tipo de empleado no existe
         */
        EmployeeTypeEntity findEmployeeTypeById(String employeeTypeId) throws NotFoundException;
