...
class EmployeeTest {
    ...
    @BeforeEach
    public void setUp() {
        employeeType = new EmployeeTypeEntity(EMPLOYEE_TYPE_ID, EMPLOYEE_TYPE_NAME);
    ...
    public void shouldCreateEmployeeWithMainConstructorWithoutId() {
        // arrange y act
        EmployeeEntity employee = new EmployeeEntity(CUI, FIRST_NAME, LAST_NAME, SALARY);
        // assert
        assertAll(
    ...
    public void shouldCreateEmployeeWithAllFieldsConstructorExeptId() {
        // arrange y act
        EmployeeEntity employee = new EmployeeEntity(CUI, FIRST_NAME, LAST_NAME, SALARY, RESIGN_DATE, employeeType,
                user);
        // asert
        assertAll(
                () -> assertEquals(CUI, employee.getCui()),
    ...
    public void shouldCreateEmployeeWithIdOnly() {
        // arrange y act
        EmployeeEntity employee = new EmployeeEntity(EMPLOYEE_ID);
        // assert
        assertAll(
