package com.sa.shared.handlers;
...
import com.sa.shared.dtos.ErrorResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    public ErrorResponseDTO handleInvalidParameterException(InvalidParameterException ex) {
        return new ErrorResponseDTO(ex.getMessage());
    }
    ...
    public ErrorResponseDTO handleConstraintViolationException(ConstraintViolationException ex) {
        String combinedMessages = ex.getConstraintViolations()
            .stream()
            .map(violation -> violation.getMessage())
            .collect(Collectors.joining(System.lineSeparator()));

        return new ErrorResponseDTO(combinedMessages);
    }
