...
class FindAllRestaurantsAdapterTest {
    ...
    private FindAllRestaurantsAdapter adapter;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.openMocks(this);
        adapter = new FindAllRestaurantsAdapter(restaurantRepository, restaurantRepositoryMapper);
    }

    @Test
    void findAll_whenRestaurantsExist_returnsListOfDomainRestaurants() {
        // Arrange
        ...
        assertEquals(expectedList, result, "Expected list of domain restaurants");
    ...
    @Test
    void findAll_whenNoRestaurants_returnsEmptyList() {
        // Arrange
