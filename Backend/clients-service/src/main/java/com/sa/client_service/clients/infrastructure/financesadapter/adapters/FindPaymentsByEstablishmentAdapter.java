...
public class FindPaymentsByEstablishmentAdapter implements FindPaymentsByClientOutputPort {
    ...
    @Override
    public List<PaymentDTO> findByClient(String clientId, String establishmentId, LocalDate fromDate, LocalDate toDate) {
        //final String REQUEST_URL = FINANCES_SERVICE_URL+"/api/v1/payments";
        String url = UriComponentsBuilder
                .fromUriString(FINANCES_SERVICE_URL)
                .path("/api/v1/payments")
                .queryParam("clientId", clientId)
                .queryParamIfPresent("establishmentId", Optional.ofNullable(establishmentId))
